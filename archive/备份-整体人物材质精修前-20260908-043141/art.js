...
if(pose.armor){
 ...
 c.beginPath();c.moveTo(-5,-36);c.lineTo(-10,-32);c.lineTo(-8,-22);c.lineTo(-14+hem,-5);c.lineTo(-2+hem*.3,-8);c.lineTo(1,-14);c.lineTo(5+hem*.3,-6);c.lineTo(13+hem,-7);c.lineTo(8,-23);c.lineTo(9,-32);c.lineTo(4,-36);c.closePath();c.fillStyle=pose.hero?'#e5e3d7':'#b7d0c4';c.fill();c.strokeStyle='#244c48';c.lineWidth=1.5;c.stroke();
...
function arm(shoulder,hand,bend,col=ink){
 ...
 line([shoulder,elbow,joint],pose.armor?'#887d52':'#365d51',7.1);line([shoulder,elbow,joint],pose.armor?'#d9dccb':pose.hero?'#d8dfd2':'#52786c',4.8);line([joint,hand],col,2);
