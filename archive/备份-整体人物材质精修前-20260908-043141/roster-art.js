...
function clothing(c,e,ink){if(e.type===12)return;c.save();const heavy=e.type===5||e.boss,robe=[3,9,10].includes(e.type),fast=[0,7,11].includes(e.type),fill=heavy?'#938678':robe?'#97909e':fast?'#a39480':'#b5aa92',accent=e.elite||e.boss?'#a78c53':'#695d51';
 if(e.elite||e.boss)shape(c,[[-7,-31],[-16,-28],[-22,-9],[-14,-10],[-10,-22],[10,-22],[16,-7],[22,-6],[16,-28],[7,-31]],'#746158',accent,1.1);
 if(robe){shape(c,[[-7,-31],[-12,-25],[-8,-18],[-16,-2],[-4,-6],[0,-11],[5,-3],[15,-4],[8,-19],[12,-25],[7,-31]],fill,ink,1.4);shape(c,[[3,-29],[8,-20],[15,-4],[6,-6],[-2,-23]],'#756c80');shape(c,[[-5,-29],[3,-23],[2,-9],[-4,-6]],'#ded7c9');}
 else if(heavy){shape(c,[[-9,-31],[-17,-26],[-12,-18],[-15,-6],[-4,-6],[0,-10],[5,-5],[15,-6],[12,-18],[17,-26],[9,-31]],fill,ink,1.6);shape(c,[[-8,-29],[8,-29],[9,-20],[0,-15],[-9,-20]],'#b9b7aa',accent);for(const side of [-1,1]){shape(c,[[side*9,-31],[side*18,-29],[side*19,-22],[side*10,-21]],'#786c60',ink,1.2);for(let j=0;j<3;j++){const y=-16+j*4;line(c,[[side*3,y],[side*12,y+1]],'#d1d5b6',.85);}}}
 else{shape(c,[[-6,-30],[-10,-26],[-7,-17],[-10,-8],[-3,-9],[0,-13],[5,-8],[11,-10],[7,-18],[10,-26],[6,-30]],fill,ink,1.2);shape(c,[[2,-28],[7,-25],[7,-18],[11,-10],[5,-8],[-1,-22]],'#8a7967');if(fast)shape(c,[[-8,-16],[-2,-17],[-3,-8],[-10,-7]],'#d5ccb4',accent,.8);}
