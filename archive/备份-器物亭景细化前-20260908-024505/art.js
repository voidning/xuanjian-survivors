...
function figure(x,y,kind,phase,walk,dir=1,casting=0,pose={}){c.save();c.translate(x,y);c.scale(.80,.80);ellipse(1,4,19,5,'#d0d9cc');ellipse(0,3,12,2.5,'#bfccbd');const gait=pose.gait??phase*10,amount=pose.walkAmount??(walk?1:0),weight=Math.sin(gait)*amount;
...
if(pose.armor){
 ...
 c.beginPath();c.moveTo(-5,-36);c.lineTo(-10,-32);c.lineTo(-8,-22);c.lineTo(-14+hem,-5);c.lineTo(-2+hem*.3,-8);c.lineTo(1,-14);c.lineTo(5+hem*.3,-6);c.lineTo(13+hem,-7);c.lineTo(8,-23);c.lineTo(9,-32);c.lineTo(4,-36);c.closePath();c.fillStyle='#668e80';c.fill();c.strokeStyle='#345c51';c.lineWidth=1.5;c.stroke();
 c.beginPath();c.moveTo(-4,-35);c.lineTo(3,-28);c.lineTo(5,-23);c.lineTo(-2,-23);c.lineTo(-7,-31);c.closePath();c.fillStyle='#ececda';c.fill();
 c.beginPath();c.moveTo(4,-25);c.lineTo(8,-23);c.lineTo(13+hem,-7);c.lineTo(7+hem*.3,-8);c.lineTo(2,-17);c.closePath();c.fillStyle='#4c776b';c.fill();
 ...
 line([[-8,-23],[8,-23]],'#3b5c51',3);line([[5,-22],[7+hem,-14],[5+hem,-9]],'#b9aa71',1.8);
...
function arm(shoulder,hand,bend,col=ink){
 ...
 line([shoulder,elbow,joint],pose.armor?'#887d52':'#365d51',7.1);line([shoulder,elbow,joint],pose.armor?'#d9dccb':'#789d8b',4.8);line([joint,hand],col,2);
...
if(pose.robe){
 ellipse(0,-46,8,10,'#f2f1e8');ellipse(0,-46,8,10,'#3e514b',true,1.6);
 c.beginPath();c.ellipse(-1,-49,7.8,7,0,Math.PI,Math.PI*2);c.lineTo(6,-48);c.lineTo(2,-52);c.lineTo(-6,-47);c.closePath();c.fillStyle='#46564f';c.fill();
 if(pose.armor){line([[-9,-48],[-8,-56],[0,-60],[8,-56],[9,-48]],'#887d52',2);line([[-9,-48],[-10,-40]],'#887d52',2);line([[9,-48],[10,-40]],'#887d52',2);}else ellipse(-2,-58,3,3.5,'#46564f');line([[-5,-56],[3,-56]],'#bba76b',1.5);ellipse(4,-55.8,1.3,1.3,'#e1d49e');
