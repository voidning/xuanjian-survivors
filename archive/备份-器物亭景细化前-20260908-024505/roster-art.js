...
function clothing(c,e,ink){if(e.type===12)return;c.save();const heavy=e.type===5||e.boss,robe=[3,9,10].includes(e.type),fill=heavy?'#b9c3b5':robe?'#c6c8bd':'#d7d6bd',accent=e.boss?'#987347':e.elite?'#92765b':robe?'#7c8d88':'#899080';
 if(e.elite||e.boss)shape(c,[[-8,-30],[-15,-24],[-20,-6],[-12,-10],[-5,-23],[5,-23],[14,-7],[20,-5],[15,-25],[8,-30]],e.boss?'#8f8060':'#b5bba5',accent);
