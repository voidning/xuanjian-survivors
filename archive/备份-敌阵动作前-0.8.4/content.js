...
for(let j=0;j<order.length;j++){const id=order[(j+shift)%order.length],lv=this.lv(id);if(manual?id!==this.manualSkill:id===this.manualSkill)continue;if(!lv||this.cool[id]>0)continue;if(!nearest&&!['dew','angler','peril'].includes(id))continue;
