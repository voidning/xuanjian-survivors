...
function figure(x,y,kind,phase,walk,dir=1,casting=0,pose={}){c.save();c.translate(x,y);c.scale(.80,.80);ellipse(1,3,16,4,'#597f6e28');ellipse(0,2,10,2.4,'#456b5c45');const gait=pose.gait??phase*10,amount=pose.walkAmount??(walk?1:0),weight=Math.sin(gait)*amount;
...
if(pose.armor){
 ...
 c.beginPath();c.moveTo(-5,-36);c.lineTo(-10,-32);c.lineTo(-8,-22);c.lineTo(-14+hem,-5);c.lineTo(-2+hem*.3,-8);c.lineTo(1,-14);c.lineTo(5+hem*.3,-6);c.lineTo(13+hem,-7);c.lineTo(8,-23);c.lineTo(9,-32);c.lineTo(4,-36);c.closePath();c.fillStyle='#b7d0c4';c.fill();c.strokeStyle='#244c48';c.lineWidth=1.5;c.stroke();
 c.beginPath();c.moveTo(-4,-35);c.lineTo(3,-28);c.lineTo(5,-23);c.lineTo(-2,-23);c.lineTo(-7,-31);c.closePath();c.fillStyle='#e6efe7';c.fill();
 ...
 c.beginPath();c.moveTo(-6,-36);c.lineTo(-12,-32);c.lineTo(-9,-25);c.lineTo(2,-19);c.lineTo(7+hem*.3,-7);c.lineTo(13+hem,-7);c.lineTo(8,-23);c.lineTo(-1,-28);c.closePath();c.fillStyle='#285b57';c.fill();c.strokeStyle='#1e4341';c.lineWidth=1;c.stroke();
 ...
 line([[-11+hem,-7],[-7,-20]],'#41695e',1);line([[7,-20],[11+hem,-8]],'#142f30',1);line([[-3,-19],[-6+hem*.3,-9]],'#95b1a3',.9);line([[5,-18],[8+hem*.3,-10]],'#95b1a3',.9);
}
...
function arm(shoulder,hand,bend,col=ink){
 ...
 line([shoulder,elbow,joint],pose.armor?'#887d52':'#365d51',7.1);line([shoulder,elbow,joint],pose.armor?'#d9dccb':'#52786c',4.8);line([joint,hand],col,2);
