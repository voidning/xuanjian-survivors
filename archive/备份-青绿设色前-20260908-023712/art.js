...
if(pose.armor){
 ...
 c.beginPath();c.moveTo(-5,-36);c.lineTo(-10,-32);c.lineTo(-8,-22);c.lineTo(-14+hem,-5);c.lineTo(-2+hem*.3,-8);c.lineTo(1,-14);c.lineTo(5+hem*.3,-6);c.lineTo(13+hem,-7);c.lineTo(8,-23);c.lineTo(9,-32);c.lineTo(4,-36);c.closePath();c.fillStyle='#e9ece3';c.fill();c.strokeStyle='#4e625b';c.lineWidth=1.5;c.stroke();
 line([[-5,-35],[3,-27],[7,-33]],'#52685e',1.3);line([[4,-35],[-4,-26],[-7,-12]],'#97a491',.9);
 line([[-8,-23],[8,-23]],'#52797a',3);line([[5,-22],[7+hem,-14],[5+hem,-9]],'#52797a',1.8);
 line([[-3,-19],[-6+hem*.3,-9]],'#afbaaa',.9);line([[5,-18],[8+hem*.3,-10]],'#afbaaa',.9);
}
...
function arm(shoulder,hand,bend,col=ink){
 ...
 line([shoulder,elbow,joint],'#53675f',6.8);line([shoulder,elbow,joint],'#e9ece3',4.5);line([joint,hand],col,2);
...
if(pose.robe){
 ...
 if(pose.armor){line([[-9,-48],[-8,-56],[0,-60],[8,-56],[9,-48]],'#887d52',2);line([[-9,-48],[-10,-40]],'#887d52',2);line([[9,-48],[10,-40]],'#887d52',2);}else ellipse(-2,-58,3,3.5,'#46564f');line([[-5,-56],[3,-56]],'#728b82',1.5);
 line([[3,-46],[5,-46]],'#3e514b',1);line([[5,-43],[6,-42],[4,-41]],'#8e998b',.8);
 line([[-5,-54],[-10,-50],[-16,-49+Math.sin(gait-.65)*amount],[-21,-51+Math.sin(gait-1)*amount]],'#627f75',1.4);
}else{
