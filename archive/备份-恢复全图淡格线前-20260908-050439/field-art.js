...
function oldPaving(c){
 // Sparse whole-world earth marks. No tile fills, continuous seams or colour halos.
 c.save();let state=48127;const rnd=()=>{state=(Math.imul(state,1664525)+1013904223)>>>0;return state/4294967296;};
