...
function bamboo(c){shadow(c,2,2,60,12);
 ...
 for(const [x,y]of [[-36,2],[-13,5],[20,3],[43,0]]){ellipse(c,x,y,13,3,'#7c89634a');for(let j=0;j<3;j++)path(c,`M${x+j*3} ${y}q-4-6 ${-5+j*3}-11`,null,'#7b8e60',.8);}
...
function pavilion(c){shadow(c,0,6,145,24);
 ...
 for(const x of [-43,43]){shape(c,[[x-3,-12],[x-3,-105],[x+3,-105],[x+3,-12]],'#9d8b71','#81735e',.8);stroke(c,[[x-2,-99],[x-2,-14]],'#c7b796',1);}
 shape(c,[[-70,-86],[70,-86],[67,-69],[-67,-69]],'#574d4033');
 ...
 path(c,'M0-159Q40-145 70-122Q99-97 132-94L105-86Q49-101 0-124Z','#405e5e',null);
 path(c,'M-122-96Q-76-109-4-153L-4-130Q-57-101-103-88Z','#829589',null);
