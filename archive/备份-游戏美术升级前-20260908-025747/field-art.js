...
function pavilion(c,x,y){c.save();c.translate(x,y);c.globalAlpha=.78;
 ...
 for(const a of [-62,62]){shape(c,[[a-4,0],[a-4,-82],[a+4,-82],[a+4,0]],'#acbca4','#879e83');stroke(c,[[a-2,-77],[a-2,-6]],'#d8e1ca',1);}
 stroke(c,[[-62,-70],[62,-70]],'#8fa58a',5);stroke(c,[[-62,-21],[62,-21]],'#b5c3aa',2);
 for(let i=-45;i<=45;i+=15)stroke(c,[[i,-20],[i,-4]],'#b2c0a6',1.5);
 shape(c,[[-106,-68],[-83,-76],[-38,-97],[0,-107],[38,-97],[83,-76],[106,-68],[67,-69],[0,-85],[-67,-69]],'#b2c5ab','#8fa789');
 shape(c,[[-99,-68],[-65,-66],[0,-81],[65,-66],[99,-68],[61,-60],[0,-72],[-61,-60]],'#cedbc1','#9bb091');
...
function bambooGrove(c,x,y){c.save();c.translate(x,y);for(let i=0;i<9;i++){const xx=i*13-54,hh=58+(i%4)*14;stroke(c,[[xx,0],[xx+4,-hh]],'#acc09f',2.1);for(let j=1;j<4;j++){const yy=-hh*j/4;stroke(c,[[xx-2,yy],[xx+5,yy]],'#dce4ce',1);const side=(i+j)%2?1:-1;stroke(c,[[xx+2,yy],[xx+side*19,yy-12]],'#afc2a1',.8);shape(c,[[xx+side*11,yy-7],[xx+side*33,yy-19],[xx+side*23,yy-6]],'#bdceb0');}}c.restore();}
...
function terrain(c){
 ...
 pavilion(c,1110,830);bambooGrove(c,970,910);bambooGrove(c,1270,755);ruin(c,1670,430);ruin(c,2480,1700);
